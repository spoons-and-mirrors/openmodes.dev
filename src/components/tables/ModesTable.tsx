        ...
        <table className="w-full text-sm">
          <thead className="bg-background-light border-b border-muted">
            <tr>
              ...
              {/* Always show status column but with different content based on user role */}
              <th
                className="text-left p-4 text-xs font-medium uppercase tracking-wide text-text-primary cursor-pointer hover:text-white transition-colors select-none"
          ...
          <tbody>
            {modes.map((mode: Mode) => (
              ...
              >
                <td className="p-4 font-semibold text-white">{mode.name}</td>
                <td className="p-4 text-text-secondary">{mode.author}</td>
                <td className="p-4 text-text-secondary max-w-xs truncate">
                  {mode.description}
                </td>
                <td className="p-4 text-text-secondary">{mode.votes}</td>
                <td className="p-4 text-text-secondary">{mode.downloads}</td>
                ...
                {/* Status column - always just show badge, no editing in table */}
                <td className="p-4">
