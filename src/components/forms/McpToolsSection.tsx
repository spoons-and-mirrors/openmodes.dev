          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <FormField label="Type">
                ...
                >
                  <SelectTrigger className="w-full h-8 text-sm !border-muted !bg-background !text-white hover:!border-accent focus:!border-accent focus:!outline-none focus:!ring-0 focus:!ring-offset-0 data-[state=open]:!border-accent !shadow-none">
            ...
            <div className="grid grid-cols-2 gap-3">
              <FormField label="Command">
                <input
                  ...
                  value={tool.command || ""}
                  onChange={(e) =>
                    onUpdateTool(index, "command", e.target.value)
                  }
                />
              </FormField>
              ...
              <FormField label="URL">
                <input
                  ...
                  value={tool.url || ""}
                  onChange={(e) => onUpdateTool(index, "url", e.target.value)}
                />
              </FormField>
            </div>
          </div>
